        ...
        {isMappingsLoading || isFormsLoading ? (
          ...
          <Grid container spacing={3}>
            {mappingsData?.map((mapping: any) => {
              const form = formsByKey.get(mapping.formKey);
              const formName = form?.name || mapping.formKey;
              return (
                <Grid item xs={12} sm={6} md={4} key={mapping.id}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Tooltip title={formName} placement="top">
                        <Typography
                          variant="h6"
                          gutterBottom
                          fontWeight={600}
                      ...
                      <Tooltip
                        title={`Form Key: ${mapping.formKey}`}
                        placement="bottom"
                      >
                        <Typography
                          variant="body2"
